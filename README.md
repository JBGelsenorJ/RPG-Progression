...
<ul>
  <li>Inmersive world</li>
  <li>Profound story / lore </li>
  <li>Exploration and quest system</li>
  <li>Items and inventory </li>
  <li>Actions & abilitiy system</li>
  <li>Experience & levels system</li>
  <li>Combat system</li>
</ul>
...
<table style="width:100%">
  ...
  <tr>
    <td>Lighter, anime/chibi art style </td>
    <td>Darker, more aestheticaly realist worlds</td>
  </tr>
  <tr>
  <td>Lineal storylines</td>
  <td>Non-linear storylines</td>
  </tr>
  <tr>
  <td>Turn based combat*</td>
  <td>Real time combat*</td>
  </tr>
</table>
...
<q> How do I improve my archery? </q>
  
  By using the bow.

<q> How do I improve my magic? </q>
...
+ Being <i>a</i> the experience needed for level 1

+ Being <i>b</i> the increment we will multiply to the previous amount of experience needed (increment)
